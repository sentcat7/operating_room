...
def output(app: StreamlitApp, name, position, data):
    ...
    if name == "CombinedDetector":
        ...
        if num_persons > 0 and num_persons <= 3:
            for i, person in enumerate(data["pose"][:3]):
                            ...
                            if inside_count >= 4:
                                if len(keypoints) >= 13:
                                    ...
                                    if any_hand_low_waist_condition:
                                        any_hand_low_waist_log = f"{detection['class_name']}: any hand lowed waist"
                                    ...
                                    if any_hand_above_head_condition:
                                        any_hand_above_head_log = f"{detection['class_name']}: any hand higher than head"
